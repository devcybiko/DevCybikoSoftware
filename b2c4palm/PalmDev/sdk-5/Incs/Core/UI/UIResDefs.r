 ...
 *		04/29/00 CS		Added a type declaration for new 'locs' resource.
 ...
 *		06/06/00 kwk	Moved 'locs' and 'cnty' to SystemResDefsPrv.r.
 *		08/24/00 kwk	Added 'wrdl' type.
 *		04/30/02 KRC	Added descriptions of the resource types in this header
 *						comment, cleaned up and added a bunch of types and
 *						information.
 *		04/30/02 KRC	Added 'taic', 'tfnf', 'Wave', 'pref' type definitions
 *						and revised the 'taif' and 'tbmf' type definitions
 *						to support newer versions (i.e. to support 16-bit
 *						color and high density bitmaps).
 *		05/02/02 KRC	More clean-up, added more type comments.  
 *						__PALMTYPES_R__ guards all definitions now.
 *						Corrected tPUT end alignment definition.
 *						Added missing tSLT type definition.
 *
 *****************************************************************************/
