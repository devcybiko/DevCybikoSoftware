 ...
 *		11/16/01	bob	Added PceNativeCall trap
 *		02/22/02	bob	Redefined sysTrapSysReserved40Trap1 as sysTrapSysHighDensitySelector
 *		04/12/02	jed	Added sysTrapMultimediaDispatch selector based trap for the MM C APIs.
 *
 *****************************************************************************/
